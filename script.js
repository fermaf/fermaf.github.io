...
(function initThree() {
    ...
    Promise.all([
        ...
        loadAsync("https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011443/1_s9dnsg_dt2vfd.mp4"),
        ...
        loadAsync("https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011443/2_hqmv8c_f7lu0h.mp4"),
        webgl.loader.load('https://i.ibb.co/DktpY1G/13.jpg'),
        webgl.loader.load('https://i.ibb.co/YhD5x95/14.jpg'),
        loadAsync("https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011446/3_qjkchz_mihjha.mp4"),
        webgl.loader.load('https://i.ibb.co/99kssL1/15.jpg'),
        loadAsync("https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011448/4_nqdsdn_sopmob.mp4"), 
        loadAsync("https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011444/5_xhz9of_wasg7q.mp4"),
        loadAsync("https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011437/6_v9cxwu_fvmi1t.mp4"),
        webgl.loader.load('https://i.ibb.co/FX4bL6Z/16.jpg'),
        loadAsync("https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011447/7_otbhqk_rkhpjq.mp4"),
        ...
        loadAsync("https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011444/8_uqve8h_oz21u5.mp4"),
        loadAsync("https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011442/9_h3zaob_qavbgy.mp4"),
        loadAsync("https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011438/10_nmlwgh_ggowrk.mp4"),
        webgl.loader.load('https://i.ibb.co/Z8jb7zk/21.jpg'),
        loadAsync("https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011444/11_cr2uom_uzx1xm.mp4"),
        loadAsync("https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011441/12q_i8przi_px1irq.mp4"),
        loadAsync("https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011440/13_kpzt8r_vzdguv.mp4"),  
    ]).then(result => {
